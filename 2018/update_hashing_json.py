...
def update_json(file_path, func, is_chaining=False, is_double=False):
...
for p in problems:
    ...
    update_json(os.path.join(base_path, file_name), func, is_chain, is_double)

print("\nAll JSON files updated with correct expected outputs!")
